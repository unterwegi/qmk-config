...
[_FL] = LAYOUT(
  ...
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_SCRL,  KC_PAUS,   _______,  KC_VOLU,
  _______,  RGB_SAI,  RGB_SAD,  RGB_SPD,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,  KC_MPRV,  KC_MNXT,             KC_VOLD,
  _______,  _______,  RGB_HUI,  RGB_HUD,  _______,  LSFT(KC_INS),  _______,  _______,  _______,  _______,  KC_MUTE,  KC_MPLY,  _______,   RGB_VAI,  KC_HOME,
